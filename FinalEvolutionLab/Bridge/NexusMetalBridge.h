...
/// Binds a CAMetalLayer (e.g. from MTKView) and initializes the bundled venue mesh renderer.
bool nexus_metal_renderer_initialize(NexusMetalRendererHandle _Nullable handle,
                                     CAMetalLayer *_Nullable layer,
                                     uint32_t width,
                                     uint32_t height);

/// Draws one frame of the resolved mobile venue mesh. Safe to call from MTKViewDelegate.
