...
| Education stub | movement_lab registered or retired | Preview, non-scoring venue metadata | **MET** |
...
**Composite mode vision score:** **7.1 / 10** — engine validate gate green; product honesty gaps remain in outcome-sport HUD labeling, surfing proxy, and live receipt POST. `movement_lab` is now registered only as preview/non-scoring metadata, not as a production venue.
