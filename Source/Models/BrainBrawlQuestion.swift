...
/// A single quiz question for Brain Brawl. Curriculum-focused for a person's learning path.
...
// MARK: - Question Bank (curriculum / path-focused; expandable via API later)
