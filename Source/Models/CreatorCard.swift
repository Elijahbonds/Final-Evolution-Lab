...
nonisolated struct CreatorCard: Identifiable, Sendable {
    ...
    /// Unreal `signature_trait_id` / `EFELSignatureTrait` (e.g. `bonds_apex_ignition`).
    let signatureTraitId: String?
    /// Short label for Athlete Card UI (e.g. "APEX IGNITION").
    let signatureMoveDisplayName: String
    /// Revenue attribution for `CreatorPayoutLedger.json` / Coach dashboard.
    let felMerchantID: String?
    ...
    static let catalog: [CreatorCard] = [
        CreatorCard(
            ...
            signatureTraitId: "dojo_ghost_strike",
            signatureMoveDisplayName: "GHOST STRIKE",
            felMerchantID: "FELMerchant_CoachV"
        ),
        CreatorCard(
            id: "bonds_bounce",
            ...
            signatureTraitId: "bonds_apex_ignition",
            signatureMoveDisplayName: "APEX IGNITION",
            felMerchantID: "FELMerchant_BondsBounce"
        ),
        CreatorCard(
            id: "flight_lab",
            ...
            signatureTraitId: "neuro_flow_teleport",
            signatureMoveDisplayName: "NEURO FLOW",
            felMerchantID: "FELMerchant_FlightLab"
        ),
        CreatorCard(
            id: "neural_max",
            ...
            signatureTraitId: "neuro_flow_teleport",
            signatureMoveDisplayName: "NEURO FLOW",
            felMerchantID: "FELMerchant_NeuralMax"
        ),
    ]
}
