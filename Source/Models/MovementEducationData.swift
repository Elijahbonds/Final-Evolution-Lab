    ...
    static let meFlightDays: [TrainingDay] = [
        ...
        TrainingDay(
            ...
            mainWork: [
                ...
                tex("me_fl_d3_5", "Continuous Hops (Tripod)", 3, "45-60s", 45, .plyometric, ["Calves", "Ankles"], "Flight Blueprint (Mod 10): extensive / regressed plyos — continuous hops 45–60s, tripod every contact (elasticity depth)", tier: .elasticityExtensive),
            ],
            isGated: false, isCompleted: false
        ),
        TrainingDay(
