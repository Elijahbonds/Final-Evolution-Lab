...
// API hook ready for AI vision (Cursor/API) and DoorDash export.
...
// Fascial Hydration Broths, CNS Ignition Snacks; 3D Kitchen / DoorDash placeholder.
...
nonisolated struct CookbookRecipe: Identifiable, Sendable, Hashable {
    ...
    /// DoorDash/grocer list export — placeholder IDs for real API.
...
// MARK: - DoorDash / Grocer API placeholder
// One-click prep: export ingredient list to real-world cart.

enum DoorDashExportService {
    /// Placeholder: in a full build, call DoorDash API or deep link to create a cart from ingredient list.
    ...
    static func exportToCart(ingredientNames: [String], mealPlanName: String?) -> URL? {
        // TODO: Integrate DoorDash Partner API or deep link.
