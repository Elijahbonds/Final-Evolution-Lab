...
interface PRQPayload { prq_score: number; mode_weight_label: string; max_prq: number; }

const HUD_PRQMeter: React.FC = () => {
  const [data, setData] = useState<PRQPayload>({ prq_score: 0, mode_weight_label: 'x1.0', max_prq: 10 });
