...
interface EconomyPayload { shards: number; xp: number; xp_cap: number; }

const HUD_ShardCounter: React.FC = () => {
  const [data, setData] = useState<EconomyPayload>({ shards: 0, xp: 0, xp_cap: 500 });
