...
public:
	...
	/** Swap mesh/radius for soccer (Meshy ball) when the asset is cooked under /Game/FEL/Environment/Soccer or StreamingAssets/Meshy. */
	void ApplyArenaBallVisual(EFELArenaMode Mode);
