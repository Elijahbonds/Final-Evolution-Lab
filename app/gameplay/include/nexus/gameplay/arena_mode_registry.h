...
public:
  ...
  [[nodiscard]] static auto releaseStateString(ArenaReleaseState state) -> std::string_view;
  [[nodiscard]] static auto releaseStateStringForMode(std::string_view modeId) -> std::string_view;
