...
constexpr std::array<DemoEntry, 18> kProductionDemoEntries{{
    ...
    {"court_carnival", "mod18", "PartyBoard", "Party Board Reaction"},
    ...
    {"skateboarding", "mod14", "TrickLine", "Trick Line Balance"},
    {"snowboarding", "mod15", "Carve", "Carve Rhythm"},
    {"brain_brawl", "mod16", "Cognition", "Cognitive Tempo"},
    {"who_scene_it", "mod17", "FilmQuiz", "Film Recall Timing"},
}};
