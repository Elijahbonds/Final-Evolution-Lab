...
constexpr std::array<DemoEntry, kProductionModeCount> kProductionDemoEntries{{
    ...
    {"gymnastics", "mod13", "Routine", "Routine Flow"},
    {"skateboarding", "mod14", "TrickChain", "Trick Chain"},
    {"snowboarding", "mod15", "Carve", "Carve Line"},
    {"brain_brawl", "mod16", "Cognitive", "Cognitive Reflex"},
    {"who_scene_it", "mod17", "Reaction", "Scene Reaction"},
    {"court_carnival", "mod18", "Arcade", "Arcade Accuracy"},
}};
