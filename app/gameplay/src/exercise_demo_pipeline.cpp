...
constexpr std::array<DemoEntry, kProductionModeCount> kProductionDemoEntries{{
    ...
    {"gymnastics", "mod13", "Routine", "Routine Precision"},
    {"brain_brawl", "mod14", "Cognition", "Cognitive Speed"},
    {"skateboarding", "mod15", "TrickLine", "Trick Line Flow"},
    {"snowboarding", "mod16", "Carve", "Mountain Flow"},
    {"who_scene_it", "mod17", "Recall", "Scene Recall"},
    {"court_carnival", "mod18", "PartyCourt", "Party Court Primer"},
}};
