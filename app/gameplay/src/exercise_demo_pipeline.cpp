...
constexpr std::array<DemoEntry, 18> kProductionDemoEntries{{
    ...
    {"skateboarding", "mod14", "TrickLine", "Trick Line Prep"},
    {"snowboarding", "mod15", "Carve", "Mountain Carve Flow"},
    {"brain_brawl", "mod16", "Cognition", "Cognitive Burst"},
    {"who_scene_it", "mod17", "BuzzIn", "Buzz-In Timing"},
    {"court_carnival", "mod18", "PartyPads", "Party Pad Circuit"},
}};
