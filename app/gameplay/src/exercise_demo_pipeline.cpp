...
constexpr std::array<DemoEntry, kProductionModeCount> kProductionDemoEntries{{
    ...
    {"skateboarding", "mod14", "Line", "Park Line Prep"},
    {"snowboarding", "mod15", "Carve", "Slope Carve Prep"},
    {"brain_brawl", "mod16", "Cognition", "Cognition Arena Prep"},
    {"who_scene_it", "mod17", "Scene", "Scene Recall Prep"},
    {"court_carnival", "mod18", "Carnival", "Carnival Control Prep"},
}};
