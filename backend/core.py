...
# Import-time startup must stay resilient in preview/CI environments where a
# local MongoDB service is not present. Requests that need DB access will still
# surface connection errors, but health/config routes can boot and report status.
