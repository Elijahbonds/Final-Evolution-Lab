...
def _counts_as_production_mode(mode_info: Dict[str, Any]) -> bool:
    return mode_info.get("status") == "production" and mode_info.get("counts_as_production_mode", True)
...
def get_seeded_game_modes():
    return [
        ...
        {"id":"basketball_dunk_3d","name":"3D H2H Dunk Contest","display_name":"3D H2H Dunk Contest","venue":"Venice Beach Blue Court","category":"Basketball","description":"NEXUS C++ dunk contest on the Venice blue court","image_url":"https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=800","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"timing"},
        {"id":"basketball_dunk_irl","name":"IRL H2H Dunk Contest","display_name":"IRL H2H Dunk Contest","venue":"Regulation Court (IRL)","category":"Basketball","description":"Real-court camera dunk contest with Vision pose scoring","image_url":"https://images.unsplash.com/photo-1574680096145-d05b474e2155?w=800","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"camera"},
...
async def get_production_modes():
    ...
    for mode_id, config in registry.items():
        ...
        modes.append({
            ...
            "counts_as_production_mode": config.get("counts_as_production_mode", True),
    ...
    return {
        ...
        "production_modes": len([m for m in modes if _counts_as_production_mode(m)]),
    ...
    return {
        ...
        "checks": {
            ...
            "mode_manager": {
                ...
                "production_modes": len([m for m in MODE_MANAGER.get("mode_manager", {}).get("mode_registry", {}).values() if _counts_as_production_mode(m)]),
