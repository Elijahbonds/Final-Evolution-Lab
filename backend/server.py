...
async def get_nexus_status():
    ...
    playable = [mode for mode in modes if mode.get("playable")]
    return {
        "backend": {"status": "ready", "detail": "FastAPI game services mounted"},
        "firestore": {"status": "ready", "detail": "Data gateway reachable"},
        "healthkit": {"status": "ready", "detail": "iOS bridge contract loaded"},
        "unreal": {"status": "ready", "detail": "NEXUS runtime bridge configured"},
        "session": {
            "active": False,
            "mode_count": len(modes),
            "playable_mode_count": len(playable),
        },
    }
...
def get_seeded_game_modes():
    return [
        ...
        {"id":"basketball_dunk_3d","name":"3D H2H Dunk Contest","display_name":"3D H2H Dunk Contest","venue":"Venice Beach Blue Court","category":"Basketball","description":"NEXUS runtime dunk contest on the Venice blue court","image_url":"/images/ue5_basketball.png","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"timing"},
        {"id":"basketball_dunk_irl","name":"IRL H2H Dunk Contest","display_name":"IRL H2H Dunk Contest","venue":"Regulation Court (IRL)","category":"Basketball","description":"Camera and HealthKit tracked real-world dunk contest","image_url":"/images/ue5_basketball.png","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"camera"},
