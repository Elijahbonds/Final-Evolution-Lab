...
def get_seeded_game_modes():
    return [
        ...
        {"id":"basketball_dunk_3d","name":"Dunk Contest 3D","display_name":"Dunk Contest · 3D","venue":"Venice Beach","category":"Basketball","description":"NEXUS C++ head-to-head dunk contest with Metal/SceneKit presentation","image_url":"/images/ue5_basketball.png","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"timing"},
        {"id":"basketball_dunk_irl","name":"Dunk Contest IRL","display_name":"Dunk Contest · IRL","venue":"Regulation Court","category":"Basketball","description":"Camera-based WDA/FIBA dunk judging for real-phone sessions","image_url":"/images/ue5_basketball.png","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"irl"},
