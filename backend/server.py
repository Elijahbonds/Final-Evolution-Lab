...
def get_seeded_game_modes():
    return [
        ...
        {"id":"basketball_dunk_3d","name":"Dunk Contest 3D","display_name":"Dunk Contest · Venice Blue","venue":"Venice Beach","category":"Basketball","description":"NEXUS in-engine dunk contest mapped to the basketball_dunk runtime","image_url":"/images/ue5_basketball.png","player_count":"1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"timing"},
        {"id":"basketball_dunk_irl","name":"IRL Dunk Contest","display_name":"Dunk Contest · IRL","venue":"Regulation Court","category":"Basketball","description":"Phone-camera dunk scoring with HealthKit and judge metadata","image_url":"/images/ue5_basketball.png","player_count":"1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"camera"},
