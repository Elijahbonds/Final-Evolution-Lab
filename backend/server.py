...
def get_seeded_game_modes():
    return [
        ...
        {"id":"basketball_dunk_3d","name":"Dunk Contest 3D","display_name":"Dunk Contest · 3D","venue":"Venice Beach","category":"Basketball","description":"Hybrid Metal/SceneKit in-engine dunk contest powered by NEXUS","image_url":"/images/ue5_basketball.png","player_count":"1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"timing"},
        {"id":"basketball_dunk_irl","name":"Dunk Contest IRL","display_name":"Dunk Contest · IRL","venue":"Regulation Court","category":"Basketball","description":"Camera-based IRL dunk contest with Vision pose and WDA/FIBA scoring","image_url":"/images/ue5_basketball.png","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"timing"},
