...
def get_seeded_game_modes():
    return [
        ...
        {"id":"basketball_dunk_3d","name":"Dunk Contest 3D","display_name":"Dunk Contest · NEXUS 3D","venue":"Venice Beach","category":"Basketball","description":"NEXUS 3D dunk contest on the Venice court","image_url":"/images/ue5_basketball.png","player_count":"1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"timing"},
        {"id":"basketball_dunk_irl","name":"IRL H2H Dunk Contest","display_name":"IRL H2H Dunk Contest","venue":"Regulation Court","category":"Basketball","description":"Camera-tracked real-court dunk contest with WDA/FIBA scoring","image_url":"/images/ue5_basketball.png","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"irl"},
