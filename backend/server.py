...
def get_seeded_game_modes():
    return [
        ...
        {"id":"basketball_dunk_irl","name":"IRL H2H Dunk Contest","display_name":"IRL H2H Dunk Contest","venue":"Regulation Court (IRL)","category":"Basketball","description":"Camera and Vision pose judged real-world dunk contest","image_url":"/images/ue5_basketball.png","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"camera"},
