...
def get_seeded_game_modes():
    return [
        ...
        {"id":"basketball_dunk_3d","name":"3D H2H Dunk Contest","display_name":"3D H2H Dunk Contest","venue":"Venice Beach","category":"Basketball","description":"NEXUS engine dunk contest with swipe timing and ghost competition","image_url":"/images/ue5_basketball.png","player_count":"1v1","duration":"5 min","difficulty":"Advanced","playable":True,"game_type":"timing"},
