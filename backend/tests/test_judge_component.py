...
class TestDunkEventSchemaExamples:
    """Verify the scoring examples in infra/dunk_event_schema.json produce documented results."""

    def test_schema_example_1_outstanding(self):
        # launch_angle=0.87, landing_precision=0.91, style_key=360_windmill
    ...
    def test_schema_example_2_perfect(self):
        # launch_angle=1.0, landing_precision=1.0, judge_offsets=[5,5,5]
...
class TestPrecisionScorer:
    ...
    def test_good_rating_within_70pct_window(self):
        ...
        result = ps.calculate_score(0, 55)
    ...
    def test_ok_rating_at_full_window(self):
        ...
        result = ps.calculate_score(0, 75)
    ...
    def test_miss_rating_outside_window(self):
        ...
        result = ps.calculate_score(0, 100)
