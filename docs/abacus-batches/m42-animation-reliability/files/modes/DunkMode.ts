// DunkMode v2.2 — REPLACES the M38 file. Clip names routed through
// SPORT_CLIP (the live audit's FEL-ANIM log confirms 'run_forward' was never
// a real clip — the player silently held a T-pose every time they approached
// at a run; the real locomotion clip is named 'run'). installSafePlay adds a
// safety net for anything this file doesn't explicitly cover. Gameplay logic
// (touch-first charge/launch, SLAM pulse, anti-stall watchdog, framed rival
// turns) is unchanged from v2.1.
