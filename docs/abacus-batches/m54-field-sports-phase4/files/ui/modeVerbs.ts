// modeVerbs v4 — REPLACES the M53 file. One change: the football deck swaps
// SPIN for TRUCK (hold) — the new power move needs the trigger stream, and
// the touch cluster budget is 4. SPIN stays available on keyboard (B).
// Everything else is byte-identical to M53 (which added the combat decks on
// top of M52's onevone/threevthree/carnival fix).
