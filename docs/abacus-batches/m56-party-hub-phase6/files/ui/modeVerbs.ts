// modeVerbs v5 — REPLACES the M54 file. One addition: the 'dunkduel' deck
// (the new pass-and-play head-to-head dunk contest — same three verbs as
// the solo Dunk Contest). Everything else is byte-identical to M54.
