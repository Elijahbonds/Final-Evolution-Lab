// StudioMode — REPLACES M28's MusicMode.tsx as the `/play/music` route
// component (keep the filename mapping whatever the router expects; default
// export is drop-in compatible, onPublish prop preserved).
//
...
type View = 'studio' | 'library' | 'creator';
