...
from pydantic import BaseModel  # used by TrajectoryRequest et al. below —
                               # was missing entirely; the module only ever
                               # got this far once the emergentintegrations
                               # import stopped failing first.
