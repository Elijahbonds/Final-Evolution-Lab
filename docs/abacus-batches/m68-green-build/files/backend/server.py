...
import httpx
# Optional private dependency — see routers/biofuel.py for the rationale.
# A hard import made the whole app unimportable on any runner that cannot
# install it, which is every CI runner.
try:
    from emergentintegrations.llm.chat import LlmChat, UserMessage
    EMERGENT_LLM_AVAILABLE = True
except ImportError:  # pragma: no cover - depends on the deploy environment
    LlmChat = UserMessage = None  # type: ignore[assignment]
