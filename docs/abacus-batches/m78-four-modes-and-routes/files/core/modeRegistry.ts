...
export const MODE_REGISTRY: ModeEntry[] = [
  ...
  // M78 wires these; flip to 'live' once the routes are deployed and
  // route_audit confirms 200.
  ...
  // ── built in M78, awaiting routes ───────────────────────────────────────
  // These were `unbuilt` in M77 — named in the backend mode manager and the
  // Nexus venue registry with no module anywhere. M78 wrote all four, so they
  // are now `unrouted`: real modules, no route yet. The distinction is the
  // whole point of the status field.
  { route: 'acting', modeId: 'acting', label: 'Acting', venueId: 'who_scene_it', backendId: null, module: 'modes/ActingMode', status: 'unrouted' },
  { route: 'irl', modeId: 'irl', label: 'IRL Dunk', venueId: 'basketball_irl', backendId: 'basketball_irl', module: 'modes/IRLMode', status: 'unrouted' },
  { route: 'brain_brawl', modeId: 'brain_brawl', label: 'Brain Brawl', venueId: 'brain_brawl', backendId: 'brain_brawl', module: 'modes/BrainBrawlMode', status: 'unrouted' },
  { route: 'who_scene_it', modeId: 'who_scene_it', label: 'Who Scene It', venueId: 'who_scene_it', backendId: 'who_scene_it', module: 'modes/WhoSceneItMode', status: 'unrouted' },
];
