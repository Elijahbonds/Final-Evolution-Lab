...
auto appendUnitCube(std::vector<MeshVertex>& vertices,
  ...
  const MeshVertex nx0y0z0{{x0, y0, z0}, {red * 0.75F, green * 0.75F, blue * 0.75F}};
  const MeshVertex nx0y0z1{{x0, y0, z1}, {red * 0.8F, green * 0.8F, blue * 0.8F}};
  const MeshVertex nx0y1z0{{x0, y1, z0}, {red * 0.9F, green * 0.9F, blue * 0.9F}};
  const MeshVertex nx0y1z1{{x0, y1, z1}, {red * 0.85F, green * 0.85F, blue * 0.85F}};
  const MeshVertex nx1y0z0{{x1, y0, z0}, {red * 0.95F, green * 0.95F, blue * 0.95F}};
  const MeshVertex nx1y0z1{{x1, y0, z1}, {red, green, blue}};
  const MeshVertex nx1y1z0{{x1, y1, z0}, {red * 1.05F, green * 1.05F, blue * 1.05F}};
  const MeshVertex nx1y1z1{{x1, y1, z1}, {red * 1.1F, green * 1.1F, blue * 1.1F}};
...
auto Mesh::createPlane(float halfExtent, float y, float red, float green, float blue) -> Mesh {
  Mesh mesh;
  const MeshVertex v0{{-halfExtent, y, -halfExtent}, {red, green, blue}};
  const MeshVertex v1{{halfExtent, y, -halfExtent}, {red, green, blue}};
  const MeshVertex v2{{halfExtent, y, halfExtent}, {red * 1.2F, green * 1.2F, blue * 1.2F}};
  const MeshVertex v3{{-halfExtent, y, halfExtent}, {red * 1.2F, green * 1.2F, blue * 1.2F}};
