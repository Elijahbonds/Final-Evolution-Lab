...
const TECH_DOCS = {
  ...
  deeplink: {
    ...
    schemes: [
      ...
      { uri: "finalevolution://mode/{modeId}", label: "Launch a specific game mode", description: "modeId is one of the 22 canonical registry entries (basketball_h2h, brain_brawl, basketball_dunk_3d, etc.)." },
