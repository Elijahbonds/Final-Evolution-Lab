...
export const MODE_STATUS = {
  basketball_h2h: "production", basketball_dunk: "production", basketball_dunk_3d: "production",
  basketball_dunk_irl: "production", basketball_3v3: "production",
...
const LOG_POOL = [
  ...
  "Mode registry validated: 22 entries · 20 production",
