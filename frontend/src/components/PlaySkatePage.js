...
import SkateMode from '@/game/modes/skate/SkateMode.js';
 ...
 * Route: /play/skate. ✕ = ollie · △ (airborne, near rail) = grind.
 */
export default function PlaySkatePage() {
  ...
  useEffect(() => {
    const mode = new SkateMode('skateboarding', canvasRef.current, containerRef.current);
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, letterSpacing: '0.1em', color: '#94a3b8' }}>VENICE STRIP</div>
