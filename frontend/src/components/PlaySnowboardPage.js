...
import SnowboardMode from '@/game/modes/snowboard/SnowboardMode.js';
 ...
 * Route: /play/snowboard. ✕ = ollie · △ (airborne, near rail) = grind.
 */
export default function PlaySnowboardPage() {
  ...
  useEffect(() => {
    const mode = new SnowboardMode('snowboarding', canvasRef.current, containerRef.current);
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, letterSpacing: '0.1em', color: '#94a3b8' }}>MOUNTAIN RUN</div>
