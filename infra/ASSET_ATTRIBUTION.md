...
| Brain Brawl original questions (24 items, ids `fel_dd_*`, `fel_ms_*`, `fel_sg_*`) | `backend/content/brainbrawl_questions.json` | Authored for Final Evolution Lab in `scripts/seed_mock_content.py` (2026-07-07) | CC0-1.0 | Includes Deep Dive explanations + micro-lessons and multi-select partial-credit items. |
