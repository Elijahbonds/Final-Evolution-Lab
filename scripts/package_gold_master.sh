...
PROJECT="$ROOT/ios/FinalEvolutionLab.xcodeproj"
SCHEME="${FEL_XCODE_SCHEME:-FinalEvolutionLab}"
...
MAC_ARCHIVE_PATH="${FEL_MAC_ARCHIVE_PATH:-$ROOT/build/FinalEvolutionLab.mac.xcarchive}"
