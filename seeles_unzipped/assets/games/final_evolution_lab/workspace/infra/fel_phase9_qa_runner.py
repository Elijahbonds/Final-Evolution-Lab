...
gate("Types", "D07", "FELGameModeBase.h removes inline EFELMatchOutcome/FFELSessionResult defs", WARN,
     "ACTION REQUIRED: Add '#include \"FELTypes.h\"' to FELGameModeBase.h and remove inline defs (lines 9-30)")
...
gate("Dist", "G10", "Android AAB: NOT YET BUILT", FAIL,
     "Run infra/android/fel_android_shipping_build.sh on Windows with Android SDK")
