...
struct FFELSessionResult
{
    GENERATED_BODY()
    UPROPERTY(BlueprintReadWrite) FString ModeId;
    UPROPERTY(BlueprintReadWrite) FString SessionId;
    UPROPERTY(BlueprintReadWrite) float Score = 0.f;
    UPROPERTY(BlueprintReadWrite) float DurationSeconds = 0.f;
    UPROPERTY(BlueprintReadWrite) bool bCompleted = false;
    UPROPERTY(BlueprintReadWrite) FString ResultType;
    UPROPERTY(BlueprintReadWrite) float XpCandidate = 0.f;
    UPROPERTY(BlueprintReadWrite) float ShardsCandidate = 0.f;
    UPROPERTY(BlueprintReadWrite) float PrqDeltaCandidate = 0.f;
    UPROPERTY(BlueprintReadWrite) FString ReplayMetadata;
};
